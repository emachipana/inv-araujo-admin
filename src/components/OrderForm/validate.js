export const validate = (values, docType, action, shipType) => {
	const errors = {};
	...
	if(shipType === "RECOJO_ALMACEN") {
		if(!values.pickupDate) errors.pickupDate = "Este campo es obligatorio";
		if(!values.pickupHour) errors.pickupHour = "Este campo es obligatorio";
	}
